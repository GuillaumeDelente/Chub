...
import io.chub.android.contacts.common.extensions.ExtendedPhoneDirectoriesManager;
import io.chub.android.contacts.common.extensions.ExtensionsFactory;
...
public class PhoneNumberListAdapter extends ContactEntryListAdapter {
    ...
    protected void bindPhoto(final ContactListItemView view, int partitionIndex, Cursor cursor) {
        ...
        if (photoId != 0) {
            ...
            Log.d(TAG, "Display photo with ID != 0");
        } else {
